...
/**
 * LkpCoverageDetailScope.java
 * 
 * @author Abdullah Imran <aImran@optimizasolutions.com>
 * @since Jan/23/2018
 **/
@Entity
@Table(name = "lkp_coverage_detail_scope")
@Audited
public class LkpCoverageDetailScope extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpCoverageDetailScope other = (LkpCoverageDetailScope) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpCoverageDetailScope [rid=" + rid + "]";
	}
