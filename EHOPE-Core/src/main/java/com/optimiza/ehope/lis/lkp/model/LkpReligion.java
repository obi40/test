 ...
 */
@Entity
@Table(name = "lkp_religion")
@Audited
public class LkpReligion extends BaseAuditableTenantedEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpReligion other = (LkpReligion) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
