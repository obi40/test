...
/**
 * LkpPaymentMethod.java
 * 
 * @author Mohammed Ayyad
 * @since 02/01/2019 ---- dd/mm/yyyy
 * 
 */

@Entity
@Table(name = "lkp_report_type")
@Audited
public class LkpReportType extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpReportType other = (LkpReportType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
