...
public class EmrPatientInfo extends BaseAuditableTenantedEntity implements Serializable {
	...
	@JoinColumn(name = "source_branch_id", updatable = false)
	private LabBranch sourceBranch;
	...
	public LabBranch getSourceBranch() {
		return sourceBranch;
	}

	public void setSourceBranch(LabBranch sourceBranch) {
