 ...
 */
@Entity
@Table(name = "lkp_organism_sensitivity")
@Audited
public class LkpOrganismSensitivity extends BaseAuditableEntity implements Serializable {
