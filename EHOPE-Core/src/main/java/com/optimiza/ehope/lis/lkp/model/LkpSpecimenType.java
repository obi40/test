 ...
 */
@Entity
@Table(name = "lkp_specimen_type")
@Audited
public class LkpSpecimenType extends BaseAuditableTenantedEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpSpecimenType other = (LkpSpecimenType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpSpecimenType [rid=" + rid + "]";
	}
