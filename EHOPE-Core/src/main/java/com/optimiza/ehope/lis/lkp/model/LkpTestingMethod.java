 ...
 */
@Entity
@Table(name = "lkp_testing_method")
@Audited
public class LkpTestingMethod extends BaseAuditableTenantedEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpTestingMethod other = (LkpTestingMethod) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpTestingMethod [rid=" + rid + "]";
	}
