 ...
 **/
@Entity
@Table(name = "lkp_serial_type")
@Audited
public class LkpSerialType extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpSerialType other = (LkpSerialType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
