...
/**
 * The persistent class for the lkp_action_code database table.
 * 
 ...
 */
@Entity
@Table(name = "lkp_action_code")
@Audited
public class LkpActionCode extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpActionCode other = (LkpActionCode) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
