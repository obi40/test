 ...
 */
@Entity
@Table(name = "lkp_specimen_temperature")
@Audited
public class LkpSpecimenTemperature extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpSpecimenTemperature other = (LkpSpecimenTemperature) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
