 ...
 */
@Entity
@Table(name = "lkp_marital_status")
@Audited
public class LkpMaritalStatus extends BaseAuditableTenantedEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpMaritalStatus other = (LkpMaritalStatus) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpMaterialStatus [rid=" + rid + "]";
	}
