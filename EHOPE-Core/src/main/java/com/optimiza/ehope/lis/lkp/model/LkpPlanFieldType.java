...
/**
 * LkpPlanFieldType.java
 * 
 * @author Abdullah Imran <aImran@optimizasolutions.com>
 * @since Aug/14/2018
 **/
@Entity
@Table(name = "lkp_plan_field_type")
@Audited
public class LkpPlanFieldType extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpPlanFieldType other = (LkpPlanFieldType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpPlanFieldType [rid=" + rid + "]";
	}
