...
/**
 * LkpOperationStatus.java
 * 
 * @author Abdullah Imran <aImran@optimizasolutions.com>
 * @since Mar/14/2018
 **/
@Entity
@Table(name = "lkp_operation_status")
@Audited
public class LkpOperationStatus extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpOperationStatus other = (LkpOperationStatus) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpOperationStatus [rid=" + rid + "]";
	}
