 ...
 */
@Entity
@Table(name = "lkp_patient_status")
@Audited
public class LkpPatientStatus extends BaseAuditableTenantedEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpPatientStatus other = (LkpPatientStatus) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpPatientStatus [rid=" + rid + "]";
	}
