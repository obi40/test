...
/**
 * LkpSerialFormat.java
 * 
 * @author Abdullah Imran <aImran@optimizasolutions.com>
 * @since Aug/06/2018
 **/
@Entity
@Table(name = "lkp_serial_format")
@Audited
public class LkpSerialFormat extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpSerialFormat other = (LkpSerialFormat) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpSerialFormat [rid=" + rid + "]";
	}
