 ...
 */
@Entity
@Table(name = "lkp_organism_type")
@Audited
public class LkpOrganismType extends BaseAuditableTenantedEntity implements Serializable {
