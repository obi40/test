...
/**
 * LkpTransactionType.java
 * 
 * @author Abdullah Imran <aImran@optimizasolutions.com>
 * @since Feb/19/2018
 **/
@Entity
@Table(name = "lkp_transaction_type")
@Audited
public class LkpTransactionType extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpTransactionType other = (LkpTransactionType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpTransactionType [rid=" + rid + "]";
	}
