...
/**
 * The persistent class for the lkp_container database table.
 * 
 ...
 */
@Entity
@Table(name = "lkp_container_type")
@Audited
public class LkpContainerType extends BaseAuditableTenantedEntity implements Serializable {
	...
	//the color code in hex with the leading #
	@NotNull
	@Size(min = 7, max = 7)
	...
	private LkpContainerImage containerImage;

	public LkpContainerType() {
	}

	public LkpContainerImage getContainerImage() {
		return containerImage;
	}

	public void setContainerImage(LkpContainerImage containerImage) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpContainerType other = (LkpContainerType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
