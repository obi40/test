 ...
 * @since 11/6/2017 --- dd/mm/yyyy
 * 
 */
@Entity
@Table(name = "lkp_blood_type")
@Audited
public class LkpBloodType extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpBloodType other = (LkpBloodType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
