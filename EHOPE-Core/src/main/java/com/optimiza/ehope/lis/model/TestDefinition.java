...
public class TestDefinition extends BaseAuditableTenantedEntity implements Serializable, Comparable<TestDefinition> {
	...
	@NotNull
	@Column(name = "is_allow_repetition_different_sample")
	@Convert(converter = BooleanIntegerConverter.class)
	private Boolean isAllowRepetitionDifferentSample;

	@NotNull
	@Column(name = "is_different_sample_chargeable")
	@Convert(converter = BooleanIntegerConverter.class)
	private Boolean isDifferentSampleChargeable;

	@NotNull
	@Column(name = "different_sample_max_amount")
	private Integer differentSampleMaxAmount;

	@NotNull
	@Column(name = "is_allow_repetition_same_sample")
	@Convert(converter = BooleanIntegerConverter.class)
	private Boolean isAllowRepetitionSameSample;

	@NotNull
	@Column(name = "is_same_sample_chargeable")
	@Convert(converter = BooleanIntegerConverter.class)
	private Boolean isSameSampleChargeable;

	@NotNull
	@Column(name = "same_sample_max_amount")
	private Integer sameSampleMaxAmount;
	...
	public Boolean getIsAllowRepetitionDifferentSample() {
		return isAllowRepetitionDifferentSample;
	}

	public void setIsAllowRepetitionDifferentSample(Boolean isAllowRepetitionDifferentSample) {
		this.isAllowRepetitionDifferentSample = isAllowRepetitionDifferentSample;
	}

	public Boolean getIsDifferentSampleChargeable() {
		return isDifferentSampleChargeable;
	}

	public void setIsDifferentSampleChargeable(Boolean isDifferentSampleChargeable) {
		this.isDifferentSampleChargeable = isDifferentSampleChargeable;
	}

	public Integer getDifferentSampleMaxAmount() {
		return differentSampleMaxAmount;
	}

	public void setDifferentSampleMaxAmount(Integer differentSampleMaxAmount) {
		this.differentSampleMaxAmount = differentSampleMaxAmount;
	}

	public Boolean getIsAllowRepetitionSameSample() {
		return isAllowRepetitionSameSample;
	}

	public void setIsAllowRepetitionSameSample(Boolean isAllowRepetitionSameSample) {
		this.isAllowRepetitionSameSample = isAllowRepetitionSameSample;
	}

	public Boolean getIsSameSampleChargeable() {
		return isSameSampleChargeable;
	}

	public void setIsSameSampleChargeable(Boolean isSameSampleChargeable) {
		this.isSameSampleChargeable = isSameSampleChargeable;
	}

	public Integer getSameSampleMaxAmount() {
		return sameSampleMaxAmount;
	}

	public void setSameSampleMaxAmount(Integer sameSampleMaxAmount) {
		this.sameSampleMaxAmount = sameSampleMaxAmount;
	}
