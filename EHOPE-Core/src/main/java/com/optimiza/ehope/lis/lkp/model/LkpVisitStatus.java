...
/**
 * The persistent class for the lkp_visit_status database table.
 * 
 ...
 */
@Entity
@Table(name = "lkp_visit_status")
@Audited
public class LkpVisitStatus extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpVisitStatus other = (LkpVisitStatus) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
