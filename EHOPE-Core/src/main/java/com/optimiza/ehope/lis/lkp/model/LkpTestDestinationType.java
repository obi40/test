 ...
 */
@Entity
@Table(name = "lkp_test_destination_type")
@Audited
public class LkpTestDestinationType extends BaseAuditableEntity implements Serializable {
