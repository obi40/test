 ...
 */
@Entity
@Table(name = "lkp_specimen_stability_unit")
@Audited
public class LkpSpecimenStabilityUnit extends BaseAuditableEntity implements Serializable {
	...
	public LkpSpecimenStabilityUnit() {
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpSpecimenStabilityUnit other = (LkpSpecimenStabilityUnit) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
