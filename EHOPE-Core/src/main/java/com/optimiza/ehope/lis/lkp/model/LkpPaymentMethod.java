 ...
 */
@Entity
@Table(name = "lkp_payment_method")
@Audited
public class LkpPaymentMethod extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpPaymentMethod other = (LkpPaymentMethod) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpPaymentMethod [rid=" + rid + "]";
	}
}