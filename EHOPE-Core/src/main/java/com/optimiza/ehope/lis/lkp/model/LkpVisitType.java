 ...
 */
@Entity
@Table(name = "lkp_visit_type")
@Audited
public class LkpVisitType extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpVisitType other = (LkpVisitType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
