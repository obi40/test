...
/**
 * LkpDependencyType.java
 * 
 * @author Eshraq Albakri <ebakri@optimizasolutions.com>
 * @since Aug/7/2017
 */
@Entity
@Table(name = "lkp_dependency_type")
@Audited
public class LkpDependencyType extends BaseAuditableTenantedEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpDependencyType other = (LkpDependencyType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpDependencyType [rid=" + rid + "]";
	}
