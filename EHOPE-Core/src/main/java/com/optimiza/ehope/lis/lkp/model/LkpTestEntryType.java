 ...
 */
@Entity
@Table(name = "lkp_test_entry_type")
@Audited
public class LkpTestEntryType extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpTestEntryType other = (LkpTestEntryType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
