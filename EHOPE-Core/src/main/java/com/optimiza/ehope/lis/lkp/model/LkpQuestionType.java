 ...
 */
@Entity
@Table(name = "lkp_question_type")
@Audited
public class LkpQuestionType extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpQuestionType other = (LkpQuestionType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpQuestionType [rid=" + rid + "]";
	}
