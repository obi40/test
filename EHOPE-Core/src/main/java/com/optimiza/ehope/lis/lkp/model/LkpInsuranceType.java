...
/**
 * LkpInsuranceType.java
 * 
 * @author Abdullah Imran <aImran@optimizasolutions.com>
 * @since Sep/09/2018
 **/
@Entity
@Table(name = "lkp_insurance_type")
@Audited
public class LkpInsuranceType extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpInsuranceType other = (LkpInsuranceType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
	...
	public String toString() {
		return "LkpInsuranceType [rid=" + rid + "]";
	}
