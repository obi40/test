 ...
 */
@Entity
@Table(name = "lkp_anti_microbial_type")
@Audited
public class LkpAntiMicrobialType extends BaseAuditableTenantedEntity implements Serializable {
