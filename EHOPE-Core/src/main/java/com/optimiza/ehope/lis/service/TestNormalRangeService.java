...
public class TestNormalRangeService extends GenericService<TestNormalRange, TestNormalRangeRepo> {
	...
	public TreeSet<TestNormalRange> filterNormalRange(EmrPatientInfo patient, Date sampleCollectionDate, Set<TestNormalRange> normalRanges) {
		TreeSet<TestNormalRange> filteredRanges = new TreeSet<TestNormalRange>();
		AgeWrapper ageWrapper = DateUtil.getAgeWithUnit(patient.getDateOfBirth(), sampleCollectionDate);
