...
/**
 * The persistent class for the lkp_visit_type database table.
 * 
 * @author Mohammed Ayyad <mayyad@optimizasolutions.com>
 * @since 11/04/2019 ---- dd/mm/yyyy
 */
@Entity
@Table(name = "lkp_print_format")
@Audited
public class LkpPrintFormat extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpPrintFormat other = (LkpPrintFormat) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
