 ...
 **/
@Entity
@Table(name = "lkp_compare_type")
@Audited
public class LkpCompareType extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpCompareType other = (LkpCompareType) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
