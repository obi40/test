...
/**
 * The persistent class for the lkp_master database table.
 * 
 */
@Entity
@Table(name = "lkp_master")
@Audited
public class LkpMaster extends BaseAuditableEntity implements Serializable {
