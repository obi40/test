...
public class BillPatientTransactionController {
	...
	public ResponseEntity<List<PaymentWrapper>> getTestsCoverageDetail(@RequestBody Long visitRid) {
		return new ResponseEntity<List<PaymentWrapper>>(patientTransactionService.getTestsCoverageDetail(visitRid),
				HttpStatus.OK);
	}
