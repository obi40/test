...
public class ImportDataController {
	...
	public ResponseEntity<List<String>> importTeamLabHistorical(
		...
		List<String> nullPatients = historicalOrderService.importTeamLabHistorical(mapper, allergy, hematology, letter, microDetails,
				microMaster,
				protein, seminal, stool, urine);

		return new ResponseEntity<List<String>>(nullPatients, HttpStatus.OK);
	}
