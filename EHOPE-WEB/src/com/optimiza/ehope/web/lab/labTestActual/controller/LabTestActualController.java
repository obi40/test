...
import com.optimiza.ehope.web.patient.wrapper.CreateTestsWrapper;
...
public class LabTestActualController {
	...
	public ResponseEntity<List<LabTestActual>> createActualTests(@RequestBody CreateTestsWrapper visitTests) {
		List<LabTestActual> labTestActualList = labTestActualService.createTestActual(visitTests.getVisitRid(),
	...
	@RequestMapping(value = "/deleteActualTests.srvc", method = RequestMethod.POST)
	public ResponseEntity<Object> deleteActualTests(@RequestBody List<Long> testActualsRid) {
		labTestActualService.deleteTestActualsByRid(testActualsRid);
	...
	@RequestMapping(value = "/reorderActualTests.srvc", method = RequestMethod.POST)
	public ResponseEntity<String> reorderActualTests(@RequestBody List<Long> actualTestRids) {
		labTestActualService.reorderActualTests(actualTestRids);
		return new ResponseEntity<String>("Success", HttpStatus.OK);
	}
