    ...
    app.service('paymentFormService',
        ["$mdDialog", "lovService", "patientProfileService", "orderFormService",
            function ($mdDialog, lovService, patientProfileService, orderFormService) {
                ...
                this.skipPayment = function (visit, paymentInformations, callback) {
                    ...
                    data.paymentInformations[0].chargeSlips = this.preparePaymentAuthorizationList(paymentInformations);
                ...
                this.preparePaymentAuthorizationList = function (paymentInformations) {
                    var result = [];
                    for (var paymentWrapperKey in paymentInformations) {
                        var payObj = angular.copy(paymentInformations[paymentWrapperKey]);
                ...
                this.paymentDialog = function (data) {
                    ...
                    var paymentInformations = data.paymentInformations;
                    ...
                    $mdDialog.show({
                        controller: ["$scope", "$mdDialog", "paymentFormService", function ($scope, $mdDialog, paymentFormService) {
                            ...
                            function fullPayment() {
                                ...
                                map.paymentInformations[0].chargeSlips = paymentFormService.preparePaymentAuthorizationList(paymentInformations);
