                ...
                function ($scope, quickTestDefinitionService, testSelectionService, lovService) {
                    ...
                    if ($scope.quickDefinitionOptions.mode === 'add') {
                        $scope.quickDefinitionOptions.testDefinition = {
                            ...
                            isAllowRepetitionDifferentSample: false,
                            isDifferentSampleChargeable: false,
                            differentSampleMaxAmount: 1,
                            isAllowRepetitionSameSample: false,
                            isSameSampleChargeable: false,
                            sameSampleMaxAmount: 1,
                            interpretations: [],
                            destinations: []
                        };
                    } else {
