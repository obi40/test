                ...
                function ($scope, destinationEntryService, WizardHandler) {
                    ...
                    function activateDirective() {
                        ...
                        destinationEntryService.getDestinationEntryData(visitRid).then(function (response) {
                            ...
                            //remove tests with one destination
                            ...
                            //sort by code
                            $scope.testDestinations.sort(function (a, b) {
                                if (a.testActual.testDefinition.standardCode > b.testActual.testDefinition.standardCode) {
                                    return 1;
                                }
                                if (a.testActual.testDefinition.standardCode < b.testActual.testDefinition.standardCode) {
                                    return -1;
                            ...
                            //skip if no destinations to choose
