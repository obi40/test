define(['app', 'config', 'util', 'commonData'], function (app, config, util, commonData) {
    ...
    app.controller('patientProfileCtrl',
        ['$rootScope', '$scope', 'patientProfileService', 'artifactService', '$state', 'clientManagementService', 'lovService', 'doctorService',
            function ($rootScope, $scope, patientProfileService, artifactService, $state, clientManagementService, lovService, doctorService) {
                ...
                var orderDataSource = new kendo.data.DataSource({
                    ...
                    transport: {
                        read: function (e) {
                            var filterMap = {
                                providerPlanRid: "providerPlan.rid",
                                lkpOperationStatusRid: "lkpOperationStatus.rid",
                                doctorRid: "doctor.rid"
                            };
                    ...
                    schema: {
                        ...
                        parse: function (response) {
                            ...
                            if (response.content != null) {
                                for (var i = 0; i < response.content.length; i++) {
                                    ...
                                    if (response.content[i].doctor === null) {
                                        response.content[i].doctor = {
                                            rid: -1
                                        };
                                    }
                                }
                        ...
                        model: {
                            ...
                            fields: {
                                ...
                                doctorRid: { from: "doctor.rid", type: "lov" },
                                doctor: { defaultValue: {} }
                            }
                        }
                    }
                ...
                $scope.orderGridOptions = {
                    ...
                    columns: [
                        ...
                        {
                            field: "doctorRid",
                            title: "{{ 'doctor' | translate }}",
                            filterable: {
                                ui: function (element) {
                                    util.createListFilter(element, allDoctors, "name." + util.userLocale);
                                }
                            },
                            template: function (dataItem) {
                                if (dataItem.doctor.rid === -1) {
                                    return "";
                                }
                                return dataItem.doctor.name[util.userLocale];
                            }
                        },
                        {
                ...
                $scope.onHistoricalOrdersTabSelection = function () {
                    if (!historicalOrdersFetched) {
                        $scope.refreshHistoricalOrderGrid();
                        historicalOrdersFetched = true;
                    }
                };
                $scope.refreshHistoricalOrderGrid = function () {
                ...
                var historicalOrderDataSource = new kendo.data.DataSource({
                    ...
                    filter: { field: "patient", operator: "eq", value: $scope.patient.rid },
                    transport: {
                        read: function (e) {
                            ...
                            for (var i = 0; i < e.data.filters.length; i++) {
                                ...
                                if (filter.field === "patient") {
                                    filter.value = $scope.patient.rid;
                                    break;
                                }
                            }
                ...
                $scope.historicalResultsGridOptions = {
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            template: function (dataItem) {
                                if (!dataItem.resultValue) {
                                    return "";
                                } else if (!dataItem.convUnit) {
                                    return dataItem.resultValue;
                                } else {
